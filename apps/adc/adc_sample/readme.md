...
| ----- | --------------- |
| [SAM HA1G16A Xplained Pro](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/ATSAMHA1G16A-XPRO)
|||
...
- Analog input (AIN1) of the ADC is fed from the DAC output
  ...
  - DAC output "DAC" is mapped to Port Pin "PA02" and is routed to "Pin 3 of the EXT1 header"
- Use a jumper wires to connect "Pin 4 of the EXT1 header" to "Pin 3 of the EXT1 header"
...
6. Refer to the table below for the switch details:
    ...
    | Board| Switch name |
    |:---------|:---------:|
    | [SAM HA1G16A Xplained Pro](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/ATSAMHA1G16A-XPRO) | SW0|
    |||
