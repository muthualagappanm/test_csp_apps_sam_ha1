...
{"0": {
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/mplab_harmony_license.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html#ac-pwm-generation",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html#description",
    "relUrl": "/apps/ac/ac_wav_gen/readme.html#description"
  },"3": {
    "doc": "AC PWM generation",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/ac/ac_wav_gen/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_ha1_xpro.X | MPLABX project for SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/ac/ac_wav_gen/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "AC PWM generation",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect a jumper between pin PA04 (Pin 16 of the EXT1 ) and PA02 (Pin 3 of the EXT1 header) | Use the Logic Analyzer/Oscilloscope and probe PA18 pin (Pin 7 of the EXT1 header) to observe the PWM output | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/ac/ac_wav_gen/readme.html#setting-up-the-hardware"
  },"5": {
    "doc": "AC PWM generation",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Observe output message in console as follows (NOTE: Pin numbers will vary as per the device): . | Observe the PWM waveform using the oscilloscope connected to the PWM output pin . | Press switch to change the duty cycle of PWM waveform | . Refer to the following table for pwm output and switch details: . | Board | PWM output pin | Switch | . | SAM HA1G16A Xplained Pro Evaluation Kit | PA18 pin (Pin 7 of the EXT1 header) | SW0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html#running-the-application",
    "relUrl": "/apps/ac/ac_wav_gen/readme.html#running-the-application"
  },"6": {
    "doc": "AC PWM generation",
    "title": "AC PWM generation",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html#adc-sample",
    "relUrl": "/apps/adc/adc_sample/readme.html#adc-sample"
  },"8": {
    "doc": "ADC Sample",
    "title": "Description",
    "content": "In this application, DAC output is fed to an analog input for the ADC conversion. An analog input is converted by a software trigger and the converted value is displayed on the console.DAC output is changed by 0.1 V upon switch press. | Board | DAC output range | . | SAM HA1G16A Xplained Pro |   | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/adc/adc_sample/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "ADC Sample",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Analog input (AIN1) of the ADC is fed from the DAC output . | Analog input (AIN1) is mapped to pin PA03 which is routed to “Pin 4 of the EXT1 header” | DAC output “DAC” is mapped to Port Pin “PA02” and is routed to “Pin 3 of the EXT1 header” | . | Use a jumper wires to connect “Pin 4 of the EXT1 header” to “Pin 3 of the EXT1 header” | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/adc/adc_sample/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "ADC Sample",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Press switch to change the DAC value | ADC input voltage changes by 0.1 V when the switch is pressed, from 0.0 V to 1.65 V | Refer to the table below for the switch details: . | Board | Switch name | . | SAM HA1G16A Xplained Pro | SW0 | . |   |   | . | Console displays the ADC count and the ADC input voltage in the console as shown below: . | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html#running-the-application",
    "relUrl": "/apps/adc/adc_sample/readme.html#running-the-application"
  },"12": {
    "doc": "ADC Sample",
    "title": "ADC Sample",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html#adc-window-sleepwalking",
    "relUrl": "/apps/adc/adc_window_sleepwalking/readme.html#adc-window-sleepwalking"
  },"14": {
    "doc": "ADC window sleepwalking",
    "title": "Description",
    "content": "This example application shows how to use the ADC Peripheral library to perform sleepwalking. The ADC peripheral is configured to operate in window mode. The ADC conversion is triggered by RTC compare 0 event. On every trigger, window detection operation is performed in standby sleep. The window interrupt is generated when the input voltage falls below the window upper threshold and the CPU is woken up by this interrupt. ADC window upper threshold is configured as 1/4 th of the reference voltage. | Board | ADC window upper threshold | . | SAM HA1G16A Xplained Pro | 0.4125 V | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/adc/adc_window_sleepwalking/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "ADC window sleepwalking",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect a voltage below the selected ADC reference voltage (VDDANA/2) to pin 4 (PA03 ) of the EXT1 | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/adc/adc_window_sleepwalking/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "ADC window sleepwalking",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Console displays ADC Window Detected when ADC input is lower than 1/4 th of the reference voltage (i.e below 0.4125 V): . | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html#running-the-application",
    "relUrl": "/apps/adc/adc_window_sleepwalking/readme.html#running-the-application"
  },"18": {
    "doc": "ADC window sleepwalking",
    "title": "ADC window sleepwalking",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/clock/clock_config/readme.html#clock-configuration",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/clock/clock_config/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/clock/clock_config/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/clock/clock_config/readme.html#downloading-and-building-the-application"
  },"22": {
    "doc": "Clock configuration",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect an oscilloscope to monitor the PORT pin PA16 (Pin 10 of the EXT1 header) | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/clock/clock_config/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/clock/clock_config/readme.html#setting-up-the-hardware"
  },"23": {
    "doc": "Clock configuration",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Observe a clock of 4 MHz on the clock output pin | LED should be blinking continuosly | . Refer to the following table for clock output pin and LED name for different boards: . | Board | Clock output pin | LED Name | . | SAM HA1G16A Xplained Pro | PA16 (Pin 10 of the EXT1 header) | LED0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/clock/clock_config/readme.html#running-the-application",
    "relUrl": "/apps/clock/clock_config/readme.html#running-the-application"
  },"24": {
    "doc": "Clock configuration",
    "title": "Clock configuration",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/clock/clock_config/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html#dac-waveform-generation",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/dac/dac_wav_gen/readme.html#downloading-and-building-the-application"
  },"28": {
    "doc": "DAC waveform generation",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect an oscilloscope to monitor the DAC pin PA02 (Pin 3 of the EXT1 header) | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/dac/dac_wav_gen/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "DAC waveform generation",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Observe a sine wave of 1 KHz frequency on DAC output pins | Press switch to toggle the waveform shape from sine wave to sawtooth wave and back | Refer to the below table for dac output pin and switch details: | . | Board | DAC output pins | Switch Name | . | SAM HA1G16A Xplained Pro | PA02 (Pin 3 of the EXT1 header) | SW0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html#running-the-application",
    "relUrl": "/apps/dac/dac_wav_gen/readme.html#running-the-application"
  },"30": {
    "doc": "DAC waveform generation",
    "title": "DAC waveform generation",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html#dac-waveform-generation-with-dma",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/dac/dac_wav_gen_dma/readme.html#downloading-and-building-the-application"
  },"34": {
    "doc": "DAC waveform generation with DMA",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect an oscilloscope to monitor the DAC pin PA02 (Pin 3 of the EXT1 ) | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/dac/dac_wav_gen_dma/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "DAC waveform generation with DMA",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Observe a sine wave of 5 KHz frequency on DAC output pin | Refer to the below table for dac output pin details: | . | Board | DACC output pins | . | SAM HA1G16A Xplained Pro | PA02 (Pin 3 of the EXT1 header) | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html#running-the-application",
    "relUrl": "/apps/dac/dac_wav_gen_dma/readme.html#running-the-application"
  },"36": {
    "doc": "DAC waveform generation with DMA",
    "title": "DAC waveform generation with DMA",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html#dmac-memory-transfer",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/dmac/dmac_memory_transfer/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "DMAC memory transfer",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/dmac/dmac_memory_transfer/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "DMAC memory transfer",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | LED indicates the success or failure: . | LED is turned ON when the DMAC memory transfer is successful. | Following table provides the LED name | . | Board Name | LED Name | . | SAM HA1G16A Xplained Pro | LED0 | . | Observe output message in console as follows: . NOTE: The number of transfer cycles may vary . | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html#running-the-application",
    "relUrl": "/apps/dmac/dmac_memory_transfer/readme.html#running-the-application"
  },"42": {
    "doc": "DMAC memory transfer",
    "title": "DMAC memory transfer",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dsu/dsu_crc32_generate/readme.html#dsu-compute-crc32",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/dsu/dsu_crc32_generate/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html#eic-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/eic/eic_led_on_off/readme.html#downloading-and-building-the-application"
  },"52": {
    "doc": "EIC Interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/eic/eic_led_on_off/readme.html#setting-up-the-hardware"
  },"53": {
    "doc": "EIC Interrupt",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | LED toggles on every switch release | . Following table provides the LED name: . | Board | Switch Name | LED Name | . | SAM HA1G16A Xplained Pro | SW0 | LED0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html#running-the-application",
    "relUrl": "/apps/eic/eic_led_on_off/readme.html#running-the-application"
  },"54": {
    "doc": "EIC Interrupt",
    "title": "EIC Interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#nvmctrl-read-write",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#downloading-and-building-the-application"
  },"58": {
    "doc": "NVMCTRL read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#running-the-application",
    "relUrl": "/apps/nvmctrl/nvmctrl_flash_read_write/readme.html#running-the-application"
  },"60": {
    "doc": "NVMCTRL read write",
    "title": "NVMCTRL read write",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/pm/pm_wakeup_eic/readme.html#pm-wakeup-using-eic",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/pm/pm_wakeup_eic/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html#port-polling",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/port/port_led_on_off_polling/readme.html#downloading-and-building-the-application"
  },"70": {
    "doc": "PORT polling",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/port/port_led_on_off_polling/readme.html#setting-up-the-hardware"
  },"71": {
    "doc": "PORT polling",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | LED is turned on when the switch is pressed and turned off when the switch is released. | . Refer the table below for details of switch and LED . | Board | Switch Name | LED Name | . | SAM HA1G16A Xplained Pro | SW0 | LED0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html#running-the-application",
    "relUrl": "/apps/port/port_led_on_off_polling/readme.html#running-the-application"
  },"72": {
    "doc": "PORT polling",
    "title": "PORT polling",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html#rtc-alarm-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtc/rtc_alarm/readme.html#downloading-and-building-the-application"
  },"76": {
    "doc": "RTC alarm interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtc/rtc_alarm/readme.html#setting-up-the-hardware"
  },"77": {
    "doc": "RTC alarm interrupt",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | The console displays the current time and the alarm time (System time starts at 12:00:00 and gets updated every second) . | Once the alarm time is reached, it print the alarm message and turns on the LED (System time keeps updating) . | . Following table provides the LED name: . | Board | LED Name | . | SAM HA1G16A Xplained Pro | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html#running-the-application",
    "relUrl": "/apps/rtc/rtc_alarm/readme.html#running-the-application"
  },"78": {
    "doc": "RTC alarm interrupt",
    "title": "RTC alarm interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html#rtc-periodic-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtc/rtc_periodic_timeout/readme.html#downloading-and-building-the-application"
  },"82": {
    "doc": "RTC periodic interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtc/rtc_periodic_timeout/readme.html#setting-up-the-hardware"
  },"83": {
    "doc": "RTC periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | The LED blinks continuously | . Following table provides the LED name: . | Board | LED Name | . | SAM HA1G16A Xplained Pro | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html#running-the-application",
    "relUrl": "/apps/rtc/rtc_periodic_timeout/readme.html#running-the-application"
  },"84": {
    "doc": "RTC periodic interrupt",
    "title": "RTC periodic interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html#sercom-i2c-eeprom-read-write",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/sercom/i2c/master/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"88": {
    "doc": "SERCOM I2C EEPROM read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect mikroBUS Xplained Pro board to EXT1 header | Plug the EEPROM 3 click Board into the MikroBus socket of the mikroBUS Xplained Pro board | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/sercom/i2c/master/i2c_eeprom/readme.html#running-the-application"
  },"90": {
    "doc": "SERCOM I2C EEPROM read write",
    "title": "SERCOM I2C EEPROM read write",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html#sercom-spi-eeprom-read-write",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/sercom/spi/spi_eeprom_write_read/readme.html#downloading-and-building-the-application"
  },"94": {
    "doc": "SERCOM SPI EEPROM read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect a mikroBUS Xplained Pro board to the EXT1 header | Plug an EEPROM 4 Click board into the MikroBus socket of the mikroBUS Xplained Pro board | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/sercom/spi/spi_eeprom_write_read/readme.html#setting-up-the-hardware"
  },"95": {
    "doc": "SERCOM SPI EEPROM read write",
    "title": "Running the Application",
    "content": ". | Build and Program the application project using its IDE | LED indicates the success or failure: . | LED is turned ON when the value read from the EEPROM matched with the written value | LED is turned OFF when the value read from the EEPROM did not match with the written value | . | . Following table provides the LED name: . | Board | LED Name | . | SAM HA1G16A Xplained Pro | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html#running-the-application",
    "relUrl": "/apps/sercom/spi/spi_eeprom_write_read/readme.html#running-the-application"
  },"96": {
    "doc": "SERCOM SPI EEPROM read write",
    "title": "SERCOM SPI EEPROM read write",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#sercom-spi-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#downloading-and-building-the-application"
  },"100": {
    "doc": "SERCOM SPI interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Use a jumper wire to short pin 16 and pin 17 of the EXT1 header | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#setting-up-the-hardware"
  },"101": {
    "doc": "SERCOM SPI interrupt",
    "title": "Running the Application",
    "content": ". | Build and Program the application project using its IDE | LED indicates the success or failure: . | The LED is turned ON when the value received matched with the transmitted value | The LED is turned OFF when the value received did not match with the transmitted value | . | SPI data transfer and compare match checking happens only one time | . Following table provides the LED name: . | Board | LED Name | . | SAM HA1G16A Xplained Pro | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/sercom/spi/spi_self_loopback_interrupt/readme.html#running-the-application"
  },"102": {
    "doc": "SERCOM SPI interrupt",
    "title": "SERCOM SPI interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_echo_interrupt/readme.html#sercom-usart-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_echo_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#sercom-usart-ring-buffer",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#downloading-and-building-the-application"
  },"112": {
    "doc": "SERCOM USART ring buffer",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro | . |   |   | . Setting up SAM HA1G16A Xplained Pro . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html#running-the-application"
  },"114": {
    "doc": "SERCOM USART ring buffer",
    "title": "SERCOM USART ring buffer",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html#systick-periodic-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/systick/systick_periodic_timeout/readme.html#setting-up-the-hardware"
  },"119": {
    "doc": "Systick periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | The LED blinks continuously | . Following table provides the LED name: . | Board | LED Name | . | SAM HA1G16A Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html#running-the-application",
    "relUrl": "/apps/systick/systick_periodic_timeout/readme.html#running-the-application"
  },"120": {
    "doc": "Systick periodic interrupt",
    "title": "Systick periodic interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html#tc-capture-mode",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/tc/tc_capture_mode/readme.html#downloading-and-building-the-application"
  },"124": {
    "doc": "TC capture mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | TC3 generates the PWM waveform on pin PA19 . | TC3 output is routed using EIC and EVSYS to TC1 input event line | . | TC1 is configured in capture mode . | Capture trigger is provided by input event line | . | Use a jumper wire to connect “Pin 8 of EXT1 (TC3_W01)” to “Pin 9 of EXT3 (EIC_EXTINT0)” | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html#running-the-application",
    "relUrl": "/apps/tc/tc_capture_mode/readme.html#running-the-application"
  },"126": {
    "doc": "TC capture mode",
    "title": "TC capture mode",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html#tc-compare-mode",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/tc/tc_compare_mode/readme.html#downloading-and-building-the-application"
  },"130": {
    "doc": "TC compare mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/tc/tc_compare_mode/readme.html#setting-up-the-hardware"
  },"131": {
    "doc": "TC compare mode",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Observe generated waveforms on the oscilloscope | . SAM HA1G16A Xplained Pro Evaluation Kit . | Timer Channel | Pin | Observable characteristic of the waveform | . | TC3_WO1 | PA19(Pin 8 of EXT1) | Active low output with 75 Hz frequency | . | TC6_WO1 | PB17(Pin 10 of EXT3) | Active high output with 75 Hz frequency | . | TC7_WO0 | PA20(Pin 15 of EXT3) | Toggle output with 37.5 Hz frequency | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html#running-the-application",
    "relUrl": "/apps/tc/tc_compare_mode/readme.html#running-the-application"
  },"132": {
    "doc": "TC compare mode",
    "title": "TC compare mode",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html#tc-timer-mode",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/tc/tc_timer_mode/readme.html#downloading-and-building-the-application"
  },"136": {
    "doc": "TC timer mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/tc/tc_timer_mode/readme.html#setting-up-the-hardware"
  },"137": {
    "doc": "TC timer mode",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Observe that the LED blinks once every second | . Following table provides the LED name: . | Board | LED Name | . | SAM HA1G16A Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html#running-the-application",
    "relUrl": "/apps/tc/tc_timer_mode/readme.html#running-the-application"
  },"138": {
    "doc": "TC timer mode",
    "title": "TC timer mode",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html#tcc-pwm-generation",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/tcc/tcc_synchronous_pwm_channels/readme.html#downloading-and-building-the-application"
  },"142": {
    "doc": "TCC PWM generation",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/tcc/tcc_synchronous_pwm_channels/readme.html#setting-up-the-hardware"
  },"143": {
    "doc": "TCC PWM generation",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | Observe the high-side and low-side PWM waveforms on oscilloscope | Observe the dead time between the high side and the low side | Observe the pwm frequency to be 10 KHz | . SAM HA1G16A Xplained Pro Evaluation Kit pin details: . | Signal Name | Pad | Pin | . | CH0-PWMH | PA04 | Pin 16 of EXT1 connector | . | CH0-PWML | PB10 | Pin 14 of EXT1 connector | . | CH1-PWMH | PA05 | Pin 18 of EXT1 connector | . | CH1-PWML | PB11 | Pin 13 of EXT1 connector | . | CH2-PWMH | PA10 | Pin 15 of EXT1 connector | . | CH2-PWML | PA16 | Pin 10 of EXT1 connector | . |   |   |   | . SAM HA1G16A Xplained Pro Evaluation Kit waveforms: . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html#running-the-application",
    "relUrl": "/apps/tcc/tcc_synchronous_pwm_channels/readme.html#running-the-application"
  },"144": {
    "doc": "TCC PWM generation",
    "title": "TCC PWM generation",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html#wdt-timeout",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html#downloading-and-building-the-application"
  },"148": {
    "doc": "WDT timeout",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html#setting-up-the-hardware"
  },"149": {
    "doc": "WDT timeout",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | LED should be blinking and the console displays the following message . | Press the switch to put the system in a deadlock | LED should stop blinking and the console should print the following message . | WDT will reset the device in four seconds and the demonstration should restart | . Refer the table below for details of switch and LED: . | Board | Switch Name | LED Name | . | SAM HA1G16A Xplained Pro Evaluation Kit | SW0 | LED0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html#running-the-application",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html#running-the-application"
  },"150": {
    "doc": "WDT timeout",
    "title": "WDT timeout",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html#ac-sleepwalking",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/ac/ac_sleepwalk_singleshot/readme.html#downloading-and-building-the-application"
  },"154": {
    "doc": "AC Sleepwalking",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect a voltage below VDD to PA04 (pin 16 of the EXT1) | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: . ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/ac/ac_sleepwalk_singleshot/readme.html#setting-up-the-hardware"
  },"155": {
    "doc": "AC Sleepwalking",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Observe output message in console as follows: . | Console displays the message stating whether voltage at AC input is lower or greater than the internal bandgap voltage (1.1 V) | LED toggles when comparison is done | . Below table shows the AC input pin and LED name for the board . | Board | AC input pin | LED name | . | SAM HA1G16A Xplained Pro Evaluation Kit | PA04 (pin 16 of the EXT1) | LED0 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html#running-the-application",
    "relUrl": "/apps/ac/ac_sleepwalk_singleshot/readme.html#running-the-application"
  },"156": {
    "doc": "AC Sleepwalking",
    "title": "AC Sleepwalking",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html",
    "relUrl": "/apps/ac/ac_sleepwalk_singleshot/readme.html"
  },"157": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"158": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM HA1 family  v3.1.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | . | SAM HA1G16A Xplained Pro Evaluation Kit | 26 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-ha1-family--v310",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-ha1-family--v310"
  },"159": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM HA1 family  v3.0.1",
    ...
    "url": "http://localhost:4000/csp_apps_sam_ha1/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-ha1-family--v301",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-ha1-family--v301"
  },"160": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM HA1 family  v3.0.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | . | SAM HA1G16A Xplained Pro Evaluation Kit | 26 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for SAM HA1 development boards | . Known Issues . The current known issues are as follows: . | None | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | . ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-ha1-family--v300",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-ha1-family--v300"
  },"161": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/release_notes.html",
    "relUrl": "/release_notes.html"
  },"162": {
    "doc": "Harmony 3 peripheral library application examples for SAM HA1 family",
    "title": "Harmony 3 peripheral library application examples for SAM HA1 family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 peripheral library application examples for SAM HA1 family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 peripheral library application examples for SAM HA1 family - [Release Notes](/csp_apps_sam_ha1/release_notes.html) - [MPLAB® Harmony License](/csp_apps_sam_ha1/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/csp_apps_sam_ha1) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains peripheral library example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/csp_apps_sam_ha1/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [AC Sleepwalking](/csp_apps_sam_ha1/apps/ac/ac_sleepwalk_singleshot/readme.html) | This example application shows how to use the AC Peripheral library to perform a single shot comparison in standby sleep mode periodically and wake up the device at the end of a successful comparison | [AC PWM generation](/csp_apps_sam_ha1/apps/ac/ac_wav_gen/readme.html) | This example application shows how to use the Analog Comparator Peripheral library to generate a 1KHz PWM waveform | [ADC Sample](/csp_apps_sam_ha1/apps/adc/adc_sample/readme.html) | This example application shows how to sample an analog input using the ADC and displays the converted samples on a serial terminal | [ADC window sleepwalking](/csp_apps_sam_ha1/apps/adc/adc_window_sleepwalking/readme.html) | This application shows how to configure ADC in a sleepwalking operation, where input voltage is measured at a fixed interval, but device is not woken from sleep until the measured value is below a given threshold | [Clock configuration](/csp_apps_sam_ha1/apps/clock/clock_config/readme.html) | This example application shows how to configure the clock system to run the device at maximum frequency. It also outputs a prescaled clock signal on a GPIO pin for measurement and verification | [DAC waveform generation](/csp_apps_sam_ha1/apps/dac/dac_wav_gen/readme.html) | This example application shows how to use the DAC to generate a 1 KHz Sine or Sawtooth wave with a lookup table | [DAC waveform generation with DMA](/csp_apps_sam_ha1/apps/dac/dac_wav_gen_dma/readme.html) | This example application shows how to use the DAC with the DMA to generate a 5 KHz sinusoidal waveform without CPU intervention | [DMAC memory transfer](/csp_apps_sam_ha1/apps/dmac/dmac_memory_transfer/readme.html) | This example application demonstrates how to use the DMAC peripheral to do a memory to memory transfer | [DSU compute CRC32](/csp_apps_sam_ha1/apps/dsu/dsu_crc32_generate/readme.html) | This example application demonstrates how to use the DSU Peripheral library to compute 32-bit Cyclic Redundancy Checksum (CRC) | [EIC Interrupt](/csp_apps_sam_ha1/apps/eic/eic_led_on_off/readme.html) | This example application demonstrates how to generate interrupt using the EIC on switch press and indicate it through an LED | [NVMCTRL read write](/csp_apps_sam_ha1/apps/nvmctrl/nvmctrl_flash_read_write/readme.html) | This example application demonstrates how to use the NVMCTRL to erase and program the internal Flash memory | [PM wakeup using EIC](/csp_apps_sam_ha1/apps/pm/pm_wakeup_eic/readme.html) | This application demonstrates entering the low power modes and exiting it using the EIC | [PORT polling](/csp_apps_sam_ha1/apps/port/port_led_on_off_polling/readme.html) | This example application demonstrate how to poll the switch input, and indicate the switch status using the LED | [RTC alarm interrupt](/csp_apps_sam_ha1/apps/rtc/rtc_alarm/readme.html) | This example shows how to use the RTC to configure the time and generate the alarm | [RTC periodic interrupt](/csp_apps_sam_ha1/apps/rtc/rtc_periodic_timeout/readme.html) | This example application shows how to use the RTC to generate periodic interrupts | [SERCOM I2C EEPROM read write](/csp_apps_sam_ha1/apps/sercom/i2c/master/i2c_eeprom/readme.html) | This example application demonstrates how to use the SERCOM peripheral to write and read from the I2C serial EEPROM memory | [SERCOM SPI EEPROM read write](/csp_apps_sam_ha1/apps/sercom/spi/spi_eeprom_write_read/readme.html) | This example application demonstrates how to use the SERCOM SPI peripheral to write and read from the SPI serial EEPROM memory | [SERCOM SPI interrupt](/csp_apps_sam_ha1/apps/sercom/spi/spi_self_loopback_interrupt/readme.html) | This example application shows how to use SERCOM SPI PLIB with external loop back to write and then read back an array of data in interrupt mode | [SERCOM USART interrupt](/csp_apps_sam_ha1/apps/sercom/usart/usart_echo_interrupt/readme.html) | This example application demonstrates how to use the SERCOM peripheral in USART mode to transfer data in a non-blocking manner | [SERCOM USART ring buffer](/csp_apps_sam_ha1/apps/sercom/usart/usart_ring_buffer_interrupt/readme.html) | This example application demonstrates how to use the SERCOM peripheral in USART ring buffer mode to transfer data in a non-blocking manner | [Systick periodic interrupt](/csp_apps_sam_ha1/apps/systick/systick_periodic_timeout/readme.html) | This example shows how to use the SysTick to generate periodic interrupts | [TC capture mode](/csp_apps_sam_ha1/apps/tc/tc_capture_mode/readme.html) | This example shows how to use the TC module in capture mode to measure duty cycle and frequency of an external input | [TC compare mode](/csp_apps_sam_ha1/apps/tc/tc_compare_mode/readme.html) | This example shows how to use the TC module in compare mode to generate an active low, active high, and toggle output on compare match | [TC timer mode](/csp_apps_sam_ha1/apps/tc/tc_timer_mode/readme.html) | This example shows how to use the TC module in timer mode to generate periodic interrupt | [TCC PWM generation](/csp_apps_sam_ha1/apps/tcc/tcc_synchronous_pwm_channels/readme.html) | This example application shows how to use the TCC to generate a 2 or 3 phase PWM signals for motor control with dead time | [WDT timeout](/csp_apps_sam_ha1/apps/wdt/wdt_timeout/readme.html) | This example shows how to generate a Watchdog timer reset by emulating a deadlock | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_sam_ha1/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/csp_apps_sam_ha1.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_sam_ha1/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/csp_apps_sam_ha1.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_sam_ha1/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/csp_apps_sam_ha1.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_sam_ha1/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/csp_apps_sam_ha1.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/csp_apps_sam_ha1.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/csp_apps_sam_ha1.svg?style=social)]() ",
    "url": "http://localhost:4000/csp_apps_sam_ha1/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "csp_apps_sam_ha1";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 peripheral library application examples for SAM HA1 family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/csp_apps_sam_ha1/assets/css/just-the-docs-' + theme + '.css');
}
